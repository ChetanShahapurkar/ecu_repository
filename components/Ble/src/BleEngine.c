 ...
 *
 */
void BleEngine__InitializeStateMachine( STATE_CONTROL_TYPE* control_ptr )
{
    ...
    if ((control_ptr != NULL) && (control_ptr->Configured == TRUE))
    {
        ...
        BleEngine__FlushEvents( control_ptr );
 ...
 */
T_BOOL BleEngine__Configure(STATE_MACHINE_DEFINITION_TYPE* state_machine_defintion_ptr)
{
            ...
            )
    {
        ...
        BleEngine__InitializeStateMachine(control_ptr);        // Start the state machine
 ...
 *
 */
EVENT_TYPE BleEngine__Execute( STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
T_BOOL BleEngine__PostEvent( STATE_CONTROL_TYPE* control_ptr, EVENT_TYPE event )
{
    T_BOOL queued = FALSE;
 ...
 *
 */
void BleEngine__FlushEvents( STATE_CONTROL_TYPE* control_ptr )
{
    // check for initialization
    if ((control_ptr != NULL) && (control_ptr->Configured == TRUE))
    {
 ...
 */
T_BOOL BleEngine__IsConfigured(STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
uint8 BleEngine__GetEventsInQueue(STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
STATE_TYPE BleEngine__GetCurrentState( STATE_CONTROL_TYPE* control_ptr )
{
