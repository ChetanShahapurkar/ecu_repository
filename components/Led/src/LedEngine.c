 ...
 *
 */
void LedEngine__InitializeStateMachine( STATE_CONTROL_TYPE* control_ptr )
{
    ...
    if ((control_ptr != NULL) && (control_ptr->Configured == TRUE))
    {
        ...
        LedEngine__FlushEvents( control_ptr );
 ...
 */
T_BOOL LedEngine__Configure(STATE_MACHINE_DEFINITION_TYPE* state_machine_defintion_ptr)
{
            ...
            )
    {
        ...
        LedEngine__InitializeStateMachine(control_ptr);        // Start the state machine
 ...
 *
 */
EVENT_TYPE LedEngine__Execute( STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
T_BOOL LedEngine__PostEvent( STATE_CONTROL_TYPE* control_ptr, EVENT_TYPE event )
{
    T_BOOL queued = FALSE;
 ...
 *
 */
void LedEngine__FlushEvents( STATE_CONTROL_TYPE* control_ptr )
{
    // check for initialization
    if ((control_ptr != NULL) && (control_ptr->Configured == TRUE))
    {
 ...
 */
T_BOOL LedEngine__IsConfigured(STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
uint8 LedEngine__GetEventsInQueue(STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
STATE_TYPE LedEngine__GetCurrentState( STATE_CONTROL_TYPE* control_ptr )
{
