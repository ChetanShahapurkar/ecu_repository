 ...
 *  @file
 *
 *  @brief      Parameterization of the Led State Engine
 *
 *
 *  $Header: LedEngine_prm.h 1.3 2014/12/01 14:17:48IST Chetan S 
 *
...
//! This definition should be placed in LedEngine.h (MKS 354947).
//! It can be placed in LedEngine_prm.h until the issue is resolved.
