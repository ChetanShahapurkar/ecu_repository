 ...
 *
 *
 *  $Header: GsmGprsEngine_prm.h 1.3 2014/12/01 14:17:48IST Chetana S Bhat (BHATCS) Exp  $
 *
 *  @copyright  *****  Copyright 2011.  Whirlpool Corporation.  All rights reserved - CONFIDENTIAL  *****
 */
//---------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------
#ifndef GsmGprsEngine_PRM_H_
#define GsmGprsEngine_PRM_H_
...
//! This definition should be placed in GsmGprsEngine.h (MKS 354947).
//! It can be placed in GsmGprsEngine_prm.h until the issue is resolved.
