...
//---------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------
#ifndef StepperMotorEngine_H_
    #define StepperMotorEngine_H_
...
T_BOOL StepperMotorEngine__Configure(STATE_MACHINE_DEFINITION_TYPE* const state_machine_defintion_ptr);
