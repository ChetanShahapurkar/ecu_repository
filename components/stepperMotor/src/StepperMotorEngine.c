 ...
 *
 */
void StepperMotorEngine__InitializeStateMachine( STATE_CONTROL_TYPE* control_ptr )
{
    ...
    if ((control_ptr != NULL) && (control_ptr->Configured == TRUE))
    {
        ...
        StepperMotorEngine__FlushEvents( control_ptr );
 ...
 */
T_BOOL StepperMotorEngine__Configure(STATE_MACHINE_DEFINITION_TYPE* state_machine_defintion_ptr)
{
            ...
            )
    {
        ...
        StepperMotorEngine__InitializeStateMachine(control_ptr);        // Start the state machine
 ...
 *
 */
EVENT_TYPE StepperMotorEngine__Execute( STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
T_BOOL StepperMotorEngine__PostEvent( STATE_CONTROL_TYPE* control_ptr, EVENT_TYPE event )
{
    T_BOOL queued = FALSE;
 ...
 *
 */
void StepperMotorEngine__FlushEvents( STATE_CONTROL_TYPE* control_ptr )
{
    // check for initialization
    if ((control_ptr != NULL) && (control_ptr->Configured == TRUE))
    {
 ...
 */
T_BOOL StepperMotorEngine__IsConfigured(STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
uint8 StepperMotorEngine__GetEventsInQueue(STATE_CONTROL_TYPE* control_ptr )
{
 ...
 */
STATE_TYPE StepperMotorEngine__GetCurrentState( STATE_CONTROL_TYPE* control_ptr )
{
